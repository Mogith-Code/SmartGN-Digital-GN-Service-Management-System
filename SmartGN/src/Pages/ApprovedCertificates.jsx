...
function ApprovedCertificates({ onOpenHelp }) {
  ...
  const loadApproved = async () => {
    try {
      ...
      console.warn(
        "API connection offline. Loading approved certificates from local fallback.",
      );
      ...
      if (localData) {
        ...
        const defaultApproved = [
          {
            ...
            publicActivitiesDetails:
              "Participated in Borella Buddhist Welfare Society activities",
            character: "Exemplary",
            remarks:
              "Applicant is personally known to me and has a clean record in the neighborhood. Recommended for requested purpose.",
        ...
        localStorage.setItem(
          ...
          JSON.stringify(defaultApproved),
        );
        ...
        <main className="flex-1 p-10 bg-[#F7FAFC] overflow-y-auto relative">
          ...
          {loading ? (
            ...
            <div className="bg-white border border-dashed border-[#cbd5e1] rounded-2xl p-12 text-center text-[#64748b] text-[15px] font-semibold shadow-sm">
              No approved certificates ready for print yet. Apply for a
              certificate and request Grama Niladhari review.
            </div>
          ) : (
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col my-8 border border-slate-200 animate-in fade-in zoom-in duration-200">
            ...
            <div className="bg-[#1B365D] text-white py-4 px-6 flex justify-between items-center font-sans">
              <span className="font-bold text-[16px] tracking-wide">
                Approved Official Document Review
              </span>
              <button
            ...
            <div className="p-8 md:p-12 overflow-y-auto bg-slate-100 flex-1 max-h-[70vh]">
              {selectedCert.certificate_type === "INCOME" ||
              selectedCert.type === "Income Certificate" ? (
                ...
                >
                  ...
                  <div className="branding-header text-center flex flex-col items-center">
                    ...
                    />
                    <h1 className="branding-title text-[20px] font-sans font-extrabold uppercase text-[#1B365D] tracking-wider m-0">
                      SmartGN
                    </h1>
                    <span className="branding-subtitle text-[11px] font-sans font-semibold text-slate-500 uppercase tracking-widest">
                  ...
                  <div className="text-center mb-8 font-sans">
                    ...
                    <span className="text-[12.5px] font-bold text-slate-700 block mt-2">
                      ...
                      {selectedCert.certificateNo || "IC/2026/0491"}
                    </span>
                    <p className="text-[11px] italic text-slate-500 max-w-xl mx-auto mt-2 font-serif leading-normal">
                      ...
                      division in which the applicant resides verifying the
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="w-[50%] py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.divisionalSecretariat ||
                        ...
                        <tr>
                          ...
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.name || selectedCert.fullName}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                            Applicant's National Identity Card No:
                          </td>
                          <td className="py-1 border-dashed-bottom font-bold text-slate-800">
                            {selectedCert.nic}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="py-1 border-dashed-bottom font-bold text-slate-800 uppercase">
                  ...
                  <div className="mb-6">
                      ...
                      <table className="w-full text-[13.5px]">
                        <tbody>
                          <tr>
                            ...
                            <td className="w-[50%] py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.landOwnerName || "N/A"}
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">Amount of Land:</td>
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.landAmount || "N/A"}
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">
                            ...
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.ownerIdentity || "N/A"}
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">
                              Paddy / Crops Obtained:
                            </td>
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.amountObtained || "0"} kg
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">
                      ...
                      <table className="w-full text-[13.5px]">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.businessNature || "N/A"}
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">
                              Pradeshiya Sabha Tax Receipt:
                            </td>
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.taxReceiptNumber || "N/A"}
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">
                            ...
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              Rs. {selectedCert.dailyMonthlyIncome || "0"}
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">
                      ...
                      <table className="w-full text-[13.5px]">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              {selectedCert.hoursWorked || "0"} hours
                            </td>
                          </tr>
                          <tr>
                            <td className="py-1 font-bold">Monthly Income:</td>
                            <td className="py-1 border-dashed-bottom italic text-slate-800">
                              Rs. {selectedCert.monthlyIncome || "0"}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <table className="w-full text-[13.5px] mt-4">
                      <tbody>
                        <tr>
                          <td className="w-[50%] py-1.5 font-bold text-[#1B365D]">
                            Certified Annual Income:
                          </td>
                          <td className="w-[50%] py-1.5 border-dashed-bottom font-extrabold text-[15px] text-emerald-700">
                            Rs.{" "}
                            {selectedCert.verifiedAnnualIncome ||
                              selectedCert.annualIncome ||
                              "0"}
                          </td>
                        </tr>
                      </tbody>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="remarks-box text-[13.5px] italic text-slate-600 bg-slate-50 border border-dashed border-slate-300 rounded p-3 mt-2 min-h-[50px]">
                      {selectedCert.remarks ||
                        "No additional administrative comments added by the Grama Niladhari."}
                    </div>
                  </div>
                  ...
                  <div className="cert-clause mt-8 pt-4 border-t border-slate-200 text-[14px]">
                    <p>
                      ...
                      correct to the best of my knowledge and that applicant's
                      verified annual income is{" "}
                      ...
                      <span className="font-bold">
                        ...
                        {selectedCert.gnDivisionNumber || "Borella East"}
                      </span>
                      .
                    </p>
                  </div>
                    ...
                    <div>
                      ...
                      <span className="text-[13.5px] font-bold border-b border-slate-300 w-36 block pb-1">
                        {selectedCert.approvedDate
                          ? selectedCert.approvedDate.split(" ")[0]
                ...
                >
                  ...
                  <div className="text-center mb-8 font-sans">
                    ...
                    <span className="text-[12.5px] font-bold text-slate-700 block mt-2">
                      Certificate Serial No:{" "}
                      {selectedCert.certificateNo || "CC/2026/0491"}
                    </span>
                    <p className="text-[11px] italic text-slate-500 max-w-xl mx-auto mt-2 font-serif leading-normal">
                      This certificate is issued by the Grama Niladhari of the
                    ...
                    <table className="w-full text-[13.5px]">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.personalKnown || "Yes"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                          ...
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.personalKnown === "Yes"
                              ? selectedCert.personalKnownSince || "Since Birth"
                              : "N/A"}
                          </td>
                        </tr>
                      </tbody>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="w-[30%] py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.sex || "Male"}
                          </td>
                          <td className="w-[15%] py-1 font-bold text-center">
                            (d) Age:
                          </td>
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.age || "31"} Years
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">(e) Civil Status:</td>
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.civilStatus || "Single"}
                          </td>
                          <td className="py-1 font-bold text-center">
                            (f) Sri Lankan:
                          </td>
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.nationality || "Sri Lankan"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">(g) Religion:</td>
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.religion || "Buddhist"}
                          </td>
                          <td className="py-1 font-bold text-center">
                            (h) Occupation:
                          </td>
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.occupation || "Software Developer"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                          ...
                          <td
                            ...
                            className="py-1 border-dashed-bottom italic text-slate-800"
                          >
                            {selectedCert.villagePeriod || "15 Years"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                        ...
                        <tr>
                          ...
                          <td
                            ...
                            className="py-1 border-dashed-bottom italic text-slate-800"
                          >
                            {selectedCert.electoralRegister || "Registered"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                          ...
                          <td
                            ...
                            className="py-1 border-dashed-bottom italic text-slate-800"
                          >
                            {selectedCert.fatherName || "(Not specified)"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                          ...
                          <td
                            ...
                            className="py-1 border-dashed-bottom italic text-slate-800"
                          >
                            {selectedCert.fatherAddress || "(Not specified)"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                    ...
                    <table className="w-full text-[13.5px]">
                      <tbody>
                        <tr>
                          ...
                          <td className="w-[50%] py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.gnPeriod || "15 Years"}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-1 font-bold">
                          ...
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.natureOfOtherEvidences ||
                              "Utility Bill"}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.convictedByCourt === "Yes"
                              ? `Yes - ${selectedCert.convictedDetails}`
                              : "No"}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="py-1 border-dashed-bottom italic text-slate-800">
                            {selectedCert.publicActivitiesInterest === "Yes"
                              ? `Yes - ${selectedCert.publicActivitiesDetails}`
                              : "No"}
                          </td>
                        </tr>
                        <tr>
