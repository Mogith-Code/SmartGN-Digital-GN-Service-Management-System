...
const successTranslations = {
  EN: {
    ...
    subtitle:
      "Your resident account has been created and registered with the digital Grama Niladhari service portal.",
    nextSteps:
      "You can now log in using your credentials to apply for certificates, request appointments, and access other services.",
  ...
  SI: {
    ...
    subtitle:
      "ඔබගේ නේවාසික ගිණුම සාර්ථකව සාදා ඩිජිටල් ග්‍රාම නිලධාරී සේවා ද්වාරයෙහි ලියාපදිංචි කර ඇත.",
    nextSteps:
      "සහතික පත්‍ර සඳහා ඉල්ලුම් කිරීමට, හමුවීම් වෙන්කරවා ගැනීමට සහ අනෙකුත් සේවාවන් ලබා ගැනීමට ඔබට දැන් ඔබගේ ගිණුම් තොරතුරු භාවිතයෙන් ඇතුල් විය හැක.",
  ...
  TA: {
    ...
    subtitle:
      "உங்கள் குடியுரிமை கணக்கு உருவாக்கப்பட்டு டிஜிட்டல் கிராம நிலதாரி சேவை போர்ட்டலில் பதிவு செய்யப்பட்டுள்ளது.",
    nextSteps:
      "சான்றிதழ்களுக்கு விண்ணப்பிக்கவும், சந்திப்புகளைக் கோரவும் மற்றும் பிற சேவைகளைப் பெறவும் இப்போது உங்கள் விவரங்களைப் பயன்படுத்தி உள்நுழையலாம்.",
    ...
    <div className="w-full min-h-screen flex flex-col justify-center items-center py-12 px-4 relative bg-[#F7FAFC]">
      ...
      <div className="w-full max-w-[550px] bg-white rounded-[32px] border border-[#2D37482D] shadow-[0_20px_50px_rgba(0,0,0,0.08)] p-8 md:p-12 flex flex-col items-center transition-all duration-300 text-center">
        ...
        <div className="mb-6 px-4 py-2 bg-[#EBF1F6] rounded-full border border-[#2D37481F]">
          <span className="text-[13px] font-medium text-gray-500 mr-1.5">
            {t.welcome}
          </span>
          <span className="text-[14px] font-semibold text-[#1B365D]">
            {successUser}
          </span>
        </div>
