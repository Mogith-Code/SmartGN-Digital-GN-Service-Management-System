...
function ApplyCharacterCertificate({ onOpenHelp }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Character certificate application submitted successfully! (Stored in Local Storage)')
      navigate('/dashboard/resident/certificates', { state: { successUser, division: userDivision } })
    }
  }
          ...
          <div className="bg-white border border-[#2D37481F] rounded-2xl p-6 shadow-[0_4px_12px_rgba(0,0,0,0.02)] mb-8 flex flex-col">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-8 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="flex flex-col">
                    <label htmlFor="divSecretariat" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                      (a) District and Divisional Secretary's Division <span className="text-red-500">*</span> :
                    </label>
                    <input 
                      type="text" 
                      id="divSecretariat" 
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="gnDivNumber" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                      (b) Grama Niladhari Division and Number <span className="text-red-500">*</span> :
                    </label>
                    <input 
                      type="text" 
                      id="gnDivNumber" 
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="personalKnown" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="personalKnownSince" className="text-[13px] font-semibold text-[#334155] mb-1.5">
              ...
              <div className="mb-8 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="flex flex-col">
                    <label htmlFor="fullName" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="address" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="sex" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="age" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="civilStatus" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="nationality" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                      (f) Whether Sri Lankan by descent or registration <span className="text-red-500">*</span> :
                    </label>
                    <input 
                      type="text" 
                      id="nationality" 
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="religion" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="occupation" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="villagePeriod" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="nic" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                      (j) National Identity Card No. <span className="text-red-500">*</span> :
                    </label>
                    <input 
                      type="text" 
                      id="nic" 
                  ...
                  <div className="flex flex-col md:col-span-2">
                    <label htmlFor="electoral" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                      (k) Number of the Electoral Register and Particulars of Registration :
                    </label>
                    <input 
                      type="text" 
                      id="electoral" 
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="fatherName" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="fatherAddress" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                  ...
                  <div className="flex flex-col md:col-span-2">
                    <label htmlFor="purpose" className="text-[13px] font-semibold text-[#334155] mb-1.5">
                      (n) Purpose for which the certificate is required <span className="text-red-500">*</span> :
                    </label>
                    <input 
                      type="text" 
                      id="purpose" 
              ...
              <div className="flex justify-end gap-4 mt-8">
                ...
                <button type="submit" className="py-2.5 px-6 bg-[#1B365D] text-white border-0 rounded-lg text-[14px] font-semibold cursor-pointer transition-all duration-200 hover:bg-[#005BBD] flex items-center gap-1.5 shadow-md">
                  Submit
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col my-8 border border-slate-200 animate-in fade-in zoom-in duration-200">
            ...
            <div className="bg-[#1B365D] text-white py-4 px-6 flex justify-between items-center">
              <span className="font-bold text-[16px] tracking-wide">Official Template Draft Preview</span>
              <button 
            ...
            <div className="p-8 md:p-12 overflow-y-auto bg-slate-100 flex-1 max-h-[70vh]">
              ...
              <div className="bg-white mx-auto border-2 border-slate-300 shadow-md p-10 max-w-[800px] text-left font-serif text-[#1e293b] leading-relaxed relative min-h-[1050px]">
                ...
                <div className="flex flex-col items-center justify-center mb-6 text-center font-sans">
                  <img src={logo} alt="SmartGN Logo" className="h-14 mb-2 object-contain" />
                  <h1 className="text-[20px] font-extrabold uppercase text-[#1B365D] tracking-wider m-0">SmartGN</h1>
                  <span className="text-[11px] font-semibold text-slate-500 uppercase tracking-widest">Digital Grama Niladhari Service Management System</span>
                ...
                <div className="text-center mb-8 font-sans">
                  ...
                  <span className="text-[12px] font-medium text-slate-500 block mt-1">Certificate ID: DRAFT-CC-PREVIEW</span>
                ...
                <div className="mb-6">
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <tbody>
                      <tr>
                        <td className="w-1/2 py-1.5 font-bold">(a) District and Divisional Secretary's Division:</td>
                        <td className="w-1/2 py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{divisionalSecretariat || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(b) Grama Niladhari Division and Number:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{gnDivisionNumber || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(c) Whether applicant is personally known to Grama Niladhari?</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{personalKnown}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(d) If so, since when?</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{personalKnown === 'Yes' ? (personalKnownSince || "Since Birth") : "N/A"}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <tbody>
                      <tr>
                        ...
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{fullName || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(b) Address:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{address || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(c) Sex:</td>
                        <td className="w-[30%] py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{sex || "(Not specified)"}</td>
                        <td className="w-[15%] py-1.5 font-bold text-center">(d) Age:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{age || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(e) Civil Status:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{civilStatus || "(Not specified)"}</td>
                        <td className="py-1.5 font-bold text-center">(f) Sri Lankan:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{nationality || "Sri Lankan"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(g) Religion:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{religion || "(Not specified)"}</td>
                        <td className="py-1.5 font-bold text-center">(h) Occupation:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{occupation || "Unemployed / Student"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(i) Residence Period in Village:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{villagePeriod || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(j) National Identity Card No:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic font-bold">{nicNumber || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(k) Electoral Register Particulars:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{electoralRegister || "Registered"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(l) Name of the Father:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{fatherName || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(m) Address of the Father:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{fatherAddress || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(n) Purpose for Certificate:</td>
                        <td colspan="3" className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic font-semibold">{purpose || "(Not specified)"}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <tbody>
                      <tr>
                        <td className="w-1/2 py-1.5 font-bold">(a) Period of residence in GN Division:</td>
                        <td className="w-1/2 py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{gnPeriod || "(Not specified)"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(b) Nature of other evidences in proof:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{natureOfOtherEvidences || "Utility Bill"}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(c) Whether convicted by a Court of Law:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{convictedByCourt === 'Yes' ? `Yes - ${convictedDetails}` : 'No'}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(d) Whether interested in public activities / social work:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic">{publicActivitiesInterest === 'Yes' ? `Yes - ${publicActivitiesDetails}` : 'No'}</td>
                      </tr>
                      <tr>
                        <td className="py-1.5 font-bold">(e) Character:</td>
                        <td className="py-1.5 border-b border-dashed border-slate-400 text-slate-700 font-sans italic font-bold">{character}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="mb-10">
                  ...
                  <div className="p-3 bg-slate-50 border border-dashed border-slate-300 rounded text-slate-600 italic text-[12px] min-h-[50px]">
                    {remarks || "No administrative remarks added in this draft."}
                  </div>
                </div>
                ...
                <div className="mt-8 pt-4 border-t border-slate-200 text-[12.5px] leading-relaxed">
                  <p>
                    It is hereby certified that the above particulars are correct to the best of my knowledge, that he/she is a citizen of Sri Lanka by descent/registration, his/her certificate of Registration Number is <span className="font-bold">[DRAFT-PREVIEW]</span> and that it has been issued by <span className="font-bold">Grama Niladhari Office</span>.
                  </p>
                </div>
                ...
                <div className="mt-14 flex justify-between items-end font-sans">
                  <div>
                    ...
                    <span className="text-[13.5px] font-bold border-b border-slate-300 w-36 block pb-1">{new Date().toLocaleDateString()}</span>
                  </div>
                  <div className="text-center">
                    ...
                    <span className="block text-[11px] text-slate-500 font-extrabold uppercase">Grama Niladhari Signature & Seal</span>
                  </div>
                </div>
