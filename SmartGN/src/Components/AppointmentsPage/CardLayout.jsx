  ...
  const cards = [
    {
      ...
      title: t.Card1Title,
      count: pendingCount,
      onClick: handleCard1Click, // ✅ No parentheses!
    },
    {
      id: 2,
      icon: approvedIcon,
      title: t.Card2Title,
      count: approvedCount,
      onClick: handleCard2Click, // ✅ No parentheses!
    },
    {
      id: 3,
      icon: addIcon,
      title: t.Card3Title,
      count: null,
      onClick: handleCard3Click, // ✅ No parentheses!
    },
  ];
    ...
    <>
      {cards.map((card) => (
        <div
          ...
          onClick={card.onClick} // ✅ Pass the function reference
        >
