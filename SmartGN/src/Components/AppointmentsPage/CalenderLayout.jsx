...
function CalendarLayout({ onDateSelect, bookings = [] }) {
  ...
  return (
    <div className="flex flex-col w-full border border-[red] items-center justify-center border border-[#2D37484D] rounded-[10px] sm:rounded-[12px] md:rounded-[15px] p-3 sm:p-4 md:p-5 lg:p-6">
      {/* CALENDAR HEADER */}
