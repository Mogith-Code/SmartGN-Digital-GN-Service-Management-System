...
function ResidentDashboardLayout() {
  ...
  return (
    <>
      ...
      <div className="flex mx-[200px] justify-center border border-[#2D37482D] rounded-[15px] bg-[#FDF5E6] mt-[30px] p-[20px]">
        <QuickActions />
      </div>

      <div className="flex mx-[200px] border border-[#2D37482D] rounded-[15px] my-[30px] p-[20px] ">
        <Announcements />
      </div>
    </>
  );
